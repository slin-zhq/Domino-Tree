...
* Domino drafter for DominoTree Chain/Cond: `<TODO: Qwen3-4B-Domino-b16 HF id>`
* DFlash drafter for DDTree/CaDDTree baselines: `<TODO: Qwen3-4B-DFlash-b16 HF id>`
...
The headline public configuration is `cond@16` with `--corr-topm 64`.
...
CaDDTree repository (`<TODO: CaDDTree repo URL>`), commit `a88f3f3`, run on the
...
(tau around 1.04). Domino-chain and DominoTree Cond use the Domino drafter;
DDTree/CaDDTree use the DFlash-native drafter.

Upstream references:

* Domino: `<TODO: Domino repo URL>`
* DDTree: https://github.com/liranringel/ddtree
* CaDDTree: `<TODO: CaDDTree repo URL>`
...
* `results/raw/dominotree/`: Domino AR / Domino-chain / DominoTree `cond@16` JSONLs.
...
```bash
DATASET=gsm8k MAX_SAMPLES=50 MAX_NEW_TOKENS=2048 METHODS=ar,chain,cond BUDGETS=16 CORR_TOPM=64 bash run_benchmark.sh
```
