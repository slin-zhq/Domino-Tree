...
#   3  Tables 5, 6, 8, 9: batch-size-1 serving (speedup + tau), its per-dataset CIs + Overall,
...
python3 results/serving/gen_longctx_budget_table.py > "$OUT/table9_longctx_budget.tex" && echo "wrote $OUT/table9_longctx_budget.tex"
